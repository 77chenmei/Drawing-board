...
(function($){
	...
	Sketch = (function(){
		...
		Sketch.prototype.download = function(format){
			...
			mine = "images/" + format;
			$('#palne').append('<img src = '+this.el.toDataURL(mine)+' class = "imgs" style = "display:none" width = "258" height = "260" >');
	...
	//		})()
		...
		Sketch.prototype.redraw = function(){
			var sketch;
			pencount = this.actions.length; //每更新一次将笔画数记录下来
	...
	$.sketch.tools.marker = {
		onEvent:function(e){
			switch(e.type){
				case 'mousedown':
				case 'touchstart': this.startPainting(); break;
				case 'mouseup':
				case 'mouseout':
				case 'mouseleave':
				case 'touchend':
				case 'touchcancel': this.stopPainting();
			}
			if(this.painting){
